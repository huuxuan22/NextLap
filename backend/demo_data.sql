...
-- 4. PRODUCTS (FK: brand_id)
INSERT INTO products (id, name, brand_id, price, description) VALUES
(1, 'iPhone 15 Pro Max', 1, 29990000, 'iPhone 15 Pro Max 256GB - Flagship mới nhất từ Apple với chip A17 Pro'),
(2, 'iPhone 14', 1, 19990000, 'iPhone 14 128GB - Điện thoại Apple với chip A15 Bionic'),
(3, 'Samsung Galaxy S24 Ultra', 2, 27990000, 'Samsung Galaxy S24 Ultra 256GB - Flagship Android với S Pen'),
(4, 'Samsung Galaxy A54', 2, 8990000, 'Samsung Galaxy A54 128GB - Điện thoại tầm trung chất lượng'),
(5, 'Xiaomi 14 Pro', 3, 18990000, 'Xiaomi 14 Pro 256GB - Flagship với camera Leica'),
(6, 'Xiaomi Redmi Note 13', 3, 5990000, 'Xiaomi Redmi Note 13 128GB - Điện thoại giá rẻ hiệu năng tốt'),
(7, 'OPPO Find X7', 4, 21990000, 'OPPO Find X7 256GB - Flagship với camera Hasselblad'),
(8, 'Vivo X100 Pro', 5, 22990000, 'Vivo X100 Pro 256GB - Flagship với camera Zeiss'),
(9, 'Realme GT 5 Pro', 6, 14990000, 'Realme GT 5 Pro 256GB - Flagship giá tốt'),
(10, 'OnePlus 12', 8, 19990000, 'OnePlus 12 256GB - Flagship với OxygenOS');

-- 5. PRODUCT_SPECS (FK: product_id)
...
-- 10. CART_ITEMS (FK: cart_id, product_id)
